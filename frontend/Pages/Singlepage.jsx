...
function SinglePage() {
  ...
  useEffect(() => {
    axios.get('https://librarymanagement-1-s431.onrender.com/Like', { params: { title: book.title } })
      .then((response) => setLike(response.data))
      .catch((error) => console.error('Error fetching likes:', error));
  }, [book.title]);

  useEffect(() => {
    axios.get('https://librarymanagement-1-s431.onrender.com/comment', { params: { title: book.title } })
  ...
  const handleRentBook = (e) => {
    e.preventDefault();
    axios.post('https://librarymanagement-1-s431.onrender.com/singlepage', {
  ...
  const handleLike = (e) => {
    e.preventDefault();
    axios.put('https://librarymanagement-1-s431.onrender.com/like', { title: book.title })
  ...
  const handleComment = (e) => {
    ...
    axios.put('https://librarymanagement-1-s431.onrender.com/comment', { title: book.title, inputComment })
      .then(() => {
