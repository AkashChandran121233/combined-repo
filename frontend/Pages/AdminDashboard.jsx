...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://librarymanagement-1-s431.onrender.com/Admindashboard')  // API endpoint
      .then((response) => {
  ...
  Promise.all([
    axios.put('https://librarymanagement-1-s431.onrender.com/books', { title: request.title , name:request.name}),  // Update rental status
    // axios.delete('http://localhost:3001/Admindashboard', { data: { title: request.title } }) , // Delete request
    axios.put('https://librarymanagement-1-s431.onrender.com/bookrequest',  {_id:request._id  } ) , // Update status
    axios.put('https://librarymanagement-1-s431.onrender.com/time',{ _id:request._id ,ExpiryTime:LastTime })  // Update status
  ])
...
const handleDecline = (request) => {
  axios.put('https://librarymanagement-1-s431.onrender.com/decline',  { title: request.title , _id:request._id } ) 
      .then(result => {
        console.log(result)
      })
      .catch(err => {
